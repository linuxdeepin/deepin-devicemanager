...
#include "../../../deepin-devicemanager/src/Widget/TextBrowser.h"
...
QT_MOC_LITERAL(1, 12, 13), // "fillClipboard"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "TextBrowser\0fillClipboard\0"
};
...
QT_INIT_METAOBJECT const QMetaObject TextBrowser::staticMetaObject = {
    { &DTextBrowser::staticMetaObject, qt_meta_stringdata_TextBrowser.data,
...
void *TextBrowser::qt_metacast(const char *_clname)
{
    ...
    return DTextBrowser::qt_metacast(_clname);
}

int TextBrowser::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DTextBrowser::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
