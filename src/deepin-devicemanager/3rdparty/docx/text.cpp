...
void Run::addBreak(WD_BREAK breakType)
{
    ...
    case WD_BREAK::LINE:
        break;
    case WD_BREAK::PAGE:
        eletype = QStringLiteral("page");
        break;
    case WD_BREAK::COLUMN:
        eletype = QStringLiteral("column");
        break;
    case WD_BREAK::LINE_CLEAR_LEFT:
        eletype = QStringLiteral("textWrapping");
        eleclear = QStringLiteral("left");
        break;
    case WD_BREAK::LINE_CLEAR_RIGHT:
        eletype = QStringLiteral("textWrapping");
        eleclear = QStringLiteral("right");
        break;
    case WD_BREAK::LINE_CLEAR_ALL:
        eletype = QStringLiteral("textWrapping");
        eleclear = QStringLiteral("all");
        break;
    default:
        break;
    }
