...
QT_MOC_LITERAL(1, 13, 20), // "OnCurrentItemChanged"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 17), // "QTableWidgetItem*"
QT_MOC_LITERAL(4, 53, 7), // "current"
QT_MOC_LITERAL(5, 61, 8) // "previous"

    },
    "MemoryWidget\0OnCurrentItemChanged\0\0"
    "QTableWidgetItem*\0current\0previous"
};
...
void MemoryWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnCurrentItemChanged((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QTableWidgetItem*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject MemoryWidget::staticMetaObject = {
    { &DeviceInfoWidgetBase::staticMetaObject, qt_meta_stringdata_MemoryWidget.data,
