...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DeviceListWidget_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject DeviceListWidget::staticMetaObject = {
    { &Dtk::Widget::DListView::staticMetaObject, qt_meta_stringdata_DeviceListWidget.data,
      qt_meta_data_DeviceListWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *DeviceListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceListWidget.stringdata0))
