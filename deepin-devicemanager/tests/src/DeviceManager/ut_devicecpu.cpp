...
TEST_F(UT_DeviceCpu, UT_DeviceCpu_setInfoFromLscpu_001)
{
    ...
    EXPECT_STREQ("", m_deviceCpu->m_CacheL1Data.toStdString().c_str());
    EXPECT_STREQ("", m_deviceCpu->m_CacheL1Order.toStdString().c_str());
    EXPECT_STREQ("", m_deviceCpu->m_CacheL2.toStdString().c_str());
    EXPECT_STREQ("", m_deviceCpu->m_CacheL3.toStdString().c_str());
