...
int edid_decode_alphanumeric_data_string(const char *from_file, std::string &str);
	// DisplayID block state
	struct {
    ...
    void detailed_block(const unsigned char *x,QString &str);
    void parse_base_block(const unsigned char *x,QString &str);
