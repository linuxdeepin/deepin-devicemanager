...
QWidget *TableViewItemDelegate::createEditor(QWidget *, const QStyleOptionViewItem &,
                                             const QModelIndex &) const
{
    return nullptr;
}

QSize TableViewItemDelegate::sizeHint(const QStyleOptionViewItem &option,
                                      const QModelIndex &index) const
{
...
void TableViewItemDelegate::initStyleOption(QStyleOptionViewItem *option,
                                            const QModelIndex &index) const
{
