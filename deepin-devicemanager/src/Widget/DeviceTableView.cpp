...
void DeviceTableView::initUI()
{
    m_itemDelegate = new TableViewItemDelegate(this);
    setItemDelegate(m_itemDelegate);

    m_headerDelegate = new TableViewHeaderView(Qt::Horizontal, this);
    ...
    this->header()->setFixedHeight(TABLE_ROW_HEIGHT);
...
void DeviceTableView::paintEvent(QPaintEvent *event)
{
...
void DeviceTableView::keyPressEvent(QKeyEvent *event)
{
...
int DeviceTableView::calulateColumnSize(int column) const
{
    qDebug() << column;
    /*
...
void DeviceTableView::setEachColunmWidthSame()
{
