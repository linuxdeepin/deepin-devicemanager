...
PageDriverInstallInfo::PageDriverInstallInfo(QWidget *parent)
    ...
    , mp_ViewNotInstall(new PageDriverTableView(this, INSTALL))
    , mp_ViewCanUpdate(new PageDriverTableView(this, INSTALL))
    , mp_AllDriverIsNew(new PageDriverTableView(this, INSTALL))
