...
static void parseEDID(QStringList allEDIDS,QString input)
{
    for (auto edid:allEDIDS) {
        ...
        if(lines.size() > 3){
            ...
            QString alphanumericData;
            edid_decode_alphanumeric_data_string(edid.toStdString().c_str(),alphanumericData);
            if (!alphanumericData.isEmpty()) {
                mapInfo["Model"] = alphanumericData;
            }
...
void M009Generator::generatorMonitorDevice()
{
...
void M009Generator::generatorNetworkDevice()
{
...
QStringList M009Generator::getNetworkInfoFromifconfig()
{
...
void M009Generator::getAudioInfoFromCatAudio()  /*this is for PAGU M009 special, conflict to master*/
{
...
void M009Generator::generatorCpuDevice()   /*this is for PAGU M009 special, conflict to master*/
{
    // 生成CPU
    // get info from lscpu
