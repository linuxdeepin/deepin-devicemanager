...
BuildRequires: libdeepin-service-framework-devel
...
Requires: lshw
Requires: util-linux
Requires: libdeepin-service-framework
...
%post
systemctl restart deepin-service-manager.service
...
%{_datadir}/polkit-1/actions/com.deepin.deepin-devicemanager.policy
%{_bindir}/deepin-devicecontrol
%{_datadir}/deepin-service-manager/other/deepin-devicecontrol.json
%{_datadir}/dbus-1/system.d/org.deepin.devicecontrol.conf
%{_datadir}/dbus-1/system-services/org.deepin.DeviceControl.service
%{_libdir}/deepin-service-manager/*
%{_datadir}/deepin-service-manager/system/deepin-deviceinfo.json
%{_datadir}/dbus-1/system.d/org.deepin.deviceinfo.conf
